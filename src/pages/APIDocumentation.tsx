                        ...
                        {selectedService ? (
                            ...
                            <div className="max-w-5xl mx-auto">
                                ...
                                >
                                    ...
                                    <ChevronRight className="h-4 w-4 text-neutral-400" />
                                    <span className="font-medium text-neutral-900">{selectedTrigramme}</span>
                                </motion.div>
                                    ...
                                    <div className="max-w-lg mx-auto">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-3 border border-neutral-300 rounded-xl focus:ring-primary-500 focus:border-primary-500 shadow-sm"
                                                value={searchTerm}
